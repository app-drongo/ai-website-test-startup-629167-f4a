...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'A minimal startup platform for testing and previewing modern web solutions. Built for developers who value simplicity and efficiency.',
  ...
  newsletterDisclaimer: 'Stay updated with our latest features. No spam, ever.',
