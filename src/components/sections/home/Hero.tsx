...
const DEFAULT_HERO = {
  badge: 'Beta: Startup Testing Platform',
  title: 'Launch your startup with confidence using our',
  titleHighlight: 'testing platform',
  description:
    'Validate your ideas, test your MVP, and gather user feedback before you scale. Perfect for tech startups looking to minimize risk and maximize success.',
  features: [
  ...
  imageAlt: 'Startup testing dashboard',
