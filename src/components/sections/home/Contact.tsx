...
const DEFAULT_CONTACT = {
  badge: 'Get In Touch',
  mainTitle: 'Ready to Build',
  mainTitleHighlight: 'Something Amazing?',
  mainDescription:
    "Let's discuss your project and see how we can help bring your startup vision to life. We're here to answer questions and explore possibilities.",
  ...
  method1Title: 'Email',
  method1Description: 'Drop us a line',
  method1Contact: 'hello@yourstartup.com',
  method2Title: 'Schedule Call',
  method2Description: 'Book a quick chat',
  method2Contact: 'Available Mon-Fri',
  method3Title: 'Quick Response',
  method3Description: 'Fast support',
  method3Contact: 'Usually within 2 hours',
  officesSectionTitle: 'Where We Work',
  office1City: 'Remote First',
  office1Address: 'Distributed team worldwide',
  office1Timezone: 'Multiple timezones',
  office2City: 'San Francisco',
  office2Address: 'Co-working spaces available',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'New York',
  office3Address: 'Meeting rooms on demand',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Availability',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '9:00 AM - 6:00 PM',
  hoursSaturdayLabel: 'Weekend',
  hoursSaturdayTime: 'Limited availability',
  hoursSundayLabel: 'Emergency',
  hoursSundayTime: 'Critical issues only',
  supportNote: 'Dedicated support for all active projects',
  nameLabel: 'Your Name *',
  namePlaceholder: 'Jane Smith',
  emailLabel: 'Email *',
  emailPlaceholder: 'jane@startup.com',
  companyLabel: 'Startup/Company',
  companyPlaceholder: 'Your Startup Name',
  messageLabel: 'Project Details *',
  messagePlaceholder:
    "Tell us about your startup idea, timeline, and what kind of help you're looking for...",
} as const;
